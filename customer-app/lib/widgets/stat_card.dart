...
class StatusBadge extends StatelessWidget {
  ...
  static const Map<String, Color> _colors = {
    // FINAL master order status flow
    'Confirmed': AppColors.amber,
    'Picked Up': AppColors.blue,
    'Cleaning': Color(0xFF7C5CFC),
    'Packaging Done': AppColors.teal,
    'Out for Delivery': AppColors.teal,
    'Delivered': AppColors.green,
    'Cancelled': AppColors.danger,
    // Rider withdrawal-request statuses (separate domain, same badge widget)
