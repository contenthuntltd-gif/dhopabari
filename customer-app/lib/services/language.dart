...
class AppLanguage {
  ...
  static const Map<String, String> _dict = {
    ...
    'না': 'No',
    'হ্যাঁ': 'Yes',
    '🔔 নতুন অর্ডার এসেছে': '🔔 New order received',
    '🔔 অর্ডার আপডেট': '🔔 Order updated',
    'শব্দ চালু করুন': 'Turn sound on',
    'শব্দ বন্ধ করুন': 'Turn sound off',
    'অর্ডার শব্দ চালু': 'Order sound on',
    'অর্ডার শব্দ বন্ধ': 'Order sound off',
    'পিকআপ': 'Pickup',
    'ডেলিভারি': 'Delivery',
    'কালেক্ট': 'Collect',
    'আজকে তুলতে হবে': "Today's pickup",
    'আজকে দিতে হবে': "Today's delivery",
    'আজকে কালেক্ট': "Today's collection",
    'আজকের পিকআপ': "Today's Pickup",
    'সব পিকআপ': 'All Pickup',
    'আজকের ডেলিভারি': "Today's Delivery",
    'সম্পন্ন ডেলিভারি': 'Completed Delivery',
    'কোনো পিকআপ নেই': 'No pickups',
    'কোনো ডেলিভারি নেই': 'No deliveries',
    'পিকআপ সম্পন্ন': 'Pickup done',
    'সম্পন্ন হয়েছে': 'Completed',
    'লন্ড্রিতে প্রসেসিং হচ্ছে': 'Processing at laundry',
    'কল করুন': 'Call',
    'পিকআপ রিসিট': 'Pickup Receipt',
    'ডেলিভারি রিসিট': 'Delivery Receipt',
    'আজকের কালেক্ট': "Today's Collection",
    'সব কালেক্ট': 'All Collection',
    'আজকে কালেক্ট হয়েছে': 'Collected today',
    'আজকে কোনো ডেলিভারি হয়নি': 'No deliveries today',
    'মোট কালেক্ট': 'Total collection',
    'কোনো হিসাব নেই': 'No records',
    ...
    'আজকের ও সব পিকআপ': "Today's & all pickups",
    'আজকের ও সম্পন্ন ডেলিভারি': "Today's & completed deliveries",
    'আজকের ও তারিখ অনুযায়ী হিসাব': "Today's & date-wise accounts",
    'কাস্টম আইটেম': 'Custom Item',
    'কাস্টম আইটেম যোগ করুন': 'Add Custom Item',
    'আইটেমের নাম': 'Item name',
    'দাম (৳)': 'Price (৳)',
    'নাম ও দাম দিন': 'Enter name and price',
    'ক্যাটাগরি': 'Category',
    'যোগ করুন': 'Add',
    'মোট ডেলিভারি': 'Total Deliveries',
    'নির্ধারিত ডেলিভারি': 'Assigned Deliveries',
    'সব দেখুন': 'View All',
    'পিকআপ শুরু': 'Start Pickup',
    'পরবর্তী ধাপ': 'Next Step',
    'বিস্তারিত': 'Details',
    'টি আইটেম': 'items',
    'বাতিল অর্ডার': 'Cancelled Orders',
    'সব অর্ডার': 'All Orders',
    'ইমেইল': 'Email',
    'আমাদের ইমেইল করুন': 'Email us',
    'মেইল': 'Mail',
    'ইমেইল অ্যাপ খোলা যায়নি': 'Could not open the email app',
    ...
    'ক্যাশ হিসাব': 'Cash Accounts',
    'রিসাইকেল বিন': 'Recycle Bin',
    'সাপোর্ট সেটিংস': 'Support Settings',
    'মেমো সেন্টার': 'Memo Center',
    'নতুন রাইডার': 'New Rider',
    'নতুন কাস্টমার': 'New Customer',
    'ডেলিভারি ও হিসাব': 'Deliveries & Cash',
    'আজ': 'Today',
    'সপ্তাহ': 'Week',
    'মাস': 'Month',
    'বছর': 'Year',
    ...
    'বুঝে পাইনি': 'Not Received',
    'বুঝে পেয়েছি': 'Received',
    'ফিরিয়ে আনুন': 'Restore',
    'স্থায়ীভাবে': 'Delete Forever',
    'ডিলিট': 'Delete',
    'সব নির্বাচন': 'Select All',
    'নতুন আইটেম যোগ করুন': 'Add New Item',
    'নাম বা ফোন নম্বর খুঁজুন': 'Search by name or phone',
    'অর্ডার নম্বর, নাম বা ফোন খুঁজুন': 'Search order no, name or phone',
